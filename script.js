...
function reportShell(title,subtitle,body,landscape=false){
  ...
  *{box-sizing:border-box}body{margin:0;padding:24px;background:#fff;color:#17221f;font-family:Arial,"Noto Sans Bengali","Noto Sans",sans-serif}
  ...
  .table-wrap{width:100%;overflow-x:auto}table{width:100%;border-collapse:collapse;background:#fff}th,td{border:1px solid #c9d6d1;text-align:center;padding:6px 5px;font-size:12px;line-height:1.3;white-space:normal;overflow-wrap:anywhere;word-break:break-word;vertical-align:middle}th{font-weight:800;background:#f0f6f3}td.name,th.name{text-align:left;white-space:normal;overflow-wrap:anywhere;word-break:break-word}.total-row td{font-weight:800;background:#f6faf8}.personal-report-table th,.personal-report-table td{padding:8px 5px;line-height:1.45}.all-years-report-table,.monthly-report-table{table-layout:fixed}.all-years-report-table col.equal-col,.monthly-report-table col.equal-col{width:var(--equal-col-width)}.all-years-report-table col.serial-col,.monthly-report-table col.serial-col{width:7%}.all-years-report-table col.name-col,.monthly-report-table col.name-col{width:18%}
